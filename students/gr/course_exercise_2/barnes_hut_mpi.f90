module barnes_hut_mpi
    ...
    !==================================================
    public :: cell
    public :: bh_init, bh_build_tree, bh_compute_forces, bh_destroy
...
contains
    ...
    !====================================================
    subroutine bh_compute_forces(head,start,end,p,a)
        type(cell), pointer :: head
        type(particle3d), intent(in) :: p(:)
        type(vector3d), intent(out) :: a(:)
        integer :: start,end

        a(start:end) = vector3d(0.0_real64,0.0_real64,0.0_real64)

        call calculate_forces(head,start,end,p,a)
    ...
    !====================================================
    subroutine calculate_forces(head,start,end,p,a)
        type(cell),pointer :: head
        type(particle3d), intent(in) :: p(:)
